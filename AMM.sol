...
contract AMM{
    ...
    uint256 constant PRECISION=1_000_000; //Precision of 6 decimal palces
    ...
    //Returns the estimate of Token1 and Token2 that will be release on burning given_share
